                ...
                <div class="box bg-primary-o-45 d-flex flex-row" style="border-top: 2px solid rgb(41, 127, 255)">
                        <div class="col-md-4">
                                ...
                                <table class="table">
                                    <tr>
                                        <td>
                                            <h5 class="mr-5 font-weight-bolder">Customer</h5>
                                        </td>
                                        <td>
                                            <h6 class="text-primary">{{$data->customer->nama_customer}}</h6>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <div class="col-md-4">
                            <table class="table">
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="font-weight-bolder">Alamat</h6>
                                    </td>
                                    <td>:</td>
                                    <td>
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex flex-row justify-content-between">
                            <div class="input-group">
                                ...
                                @if ($pajak !== 0)
                                    <a href="{{ route('invoice_penjualan', $data->id) }}" class="btn btn-dark">
                                        Show Invoice
                                    </a>
                                @else
                                    <a href="{{ route('faktur_penjualan', $data->id) }}" class="btn btn-dark">
                                        Show Faktur
                                    </a>
                                @endif
                            </div>
                            <div class="button-left d-flex flex-row">
                                ...
                                <a href="{{ route('penjualan.edit', $data->id) }}" class="btn btn-primary d-flex flex-row">Edit <i class="fa fa-paint-brush ml-2" aria-hidden="true"></i></a>
                                @if ($data->status == 1)
                                <a href="{{ url('fnc/showTagihanPenjualan', $data->id) }}" class="btn btn-success d-flex flex-row ml-2">Bayar<i class="fas fa-money-bill ml-1"></i></a>
                                @endif
                                <a href="{{ url('fnc/lacak_pembayaran_penjualan', $data->id) }}" class="btn btn-info d-flex flex-row ml-2"><i class="fas fa-book"></i>Riwayat Pembayaran</a>
                            </div>
                        </div>
                    </div>
                </div>
