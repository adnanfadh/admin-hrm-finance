                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <table class="table">
                                <tr>
                                    <td width="40%">
                                        <h6 class="font-weight-bolder">Customer</h6>
                                    </td>
                                    <td>:</td>
                                    <td class="text-primary">
                                            <h6>{{$data->penjualan->customer->nama_customer}}</h6>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="row justify-content-end mt-5">
                        <div class="col-md-6">
                            <table class="table text-right">
                                ...
                                <tr>
                                    <td>
                                        <h4 class="font-weight-bolder text-dark">Jumlah Penjualan</h4>
                                    </td>
                                    <td>
                                        <h4 class="font-weight-bolder text-dark">{{ "Rp. ".number_format($data->penjualan->total,2,',','.'); }}</h4>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <h4 class="font-weight-bolder text-primary">{{ "Rp. ".number_format($data->penjualan->sisa_tagihan,2,',','.'); }}</h4>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex flex-row justify-content-between">
                            <div class="input-group">
                                ...
                                {{-- {{ $data->id }} --}}
                                <a href="{{ route('kwitansi_penjualan', $data->id) }}" class="btn btn-dark">Show Kwitansi</a>
                            </div>
      ...
      <div class="modal-content">
        <div class="modal-body mt-5">
            <div class="title p-0 m-0">
                ...
                <h4 class="text-primary" id="exampleModalLabel">{{ $data->transaksi }} #{{ $data->no_pembayaran }}</h4>
            </div>
