            ...
            <div class="box-nav shadow-sm bg-white p-5 rounded">
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div aria-current="page">
                            <h4>Buat Pemesanan Penjualan</h4>
                        </div>
                    </div>
                    <div class="col-md-6 col-12 d-flex flex-lg-row flex-sm-column justify-content-sm-start justify-content-lg-end">
                        <div class="row">
                            {{-- <div class="col-md-6 text-right">
                                <select name="penagihan" id="penagihan" class="form-control mt-2">
                                    <option value="0">Pemesanan Penjualan</option>
                                    <option value="1">Penagihan Penjualan</option>
                                </select>
                            </div> --}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="customer_id" name="customer_id" onchange="myFunction()">
                                                    <option value="" disabled selected>-- Tentukan Customer --</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="email_customer" name="email_customer" placeholder=" E.G example@mail.com" aria-label="Example text with button addon" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="box bg-white p-5 rounded d-flex flex-column text-right">
                                                ...
                                                <div class="nominal bg-warning-o-80 p-3 rounded">
                                                    <input type="text" id="total_global" value="" class="form-control bg-transparent border-0 font-weight-bolder text-right total_global" style="font-size: 1.7rem">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @php
                                            $kode = str_pad($penjualan+1,4,'0',STR_PAD_LEFT);
                                        @endphp
                                        <input type="text" name="no_transaksi" id="no_transaksi" class="form-control" value="{{ $kode }}" readonly>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" id="akun_tujuan_group">
                                        ...
                                        <select name="akun_tujuan" id="akun_tujuan" class="form-control">
                                            ...
                                            @foreach ($akun_tujuans as $at)
                                                <option value="{{ $at->id }}">({{ $at->nomor }}) {{ $at->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group" id="nominal_tagihan_group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nominal_tagihan" id="nominal_tagihan">
                                        </div>
                                    </div>
                                    {{-- <div class="form-group" id="akun_bank_group">
                                        <label for="akun_bank" class="font-weight-bold">Akun Pembayaran:</label>
                                        <select name="akun_bank" id="bank_id" class="form-control" >
                                            <option value="" selected disabled>-- Akun Bank --</option>
                                            @foreach ($akun_tujuans as $at)
                                                <option value="{{ $at->id }}">({{ $at->nomor }}) {{ $at->nama }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="row d-flex flex-row justify-content-between">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="pesan" id="pesan" cols="30" rows="5" class="form-control" placeholder="Little note...">{{ old('pesan') }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                {{-- <div class="row mt-5">
                                    <div class="col-md-7">
                                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                            ...
                                            <div class="input-group-prepend">
                                                <input type="text" class="form-control" placeholder="Dis.." aria-label="Input group example" id="discount_global" aria-describedby="btnGroupAddon" onkeyup="total_discount_global();" value="0">
                                            </div>
                                            <div class="input-group-prepend">
                                    ...
                                    <div class="col-md-5 text-right">
                                        <input type="text" name="discount_global_result" id="discount_global_result" class="form-control bg-transparent border-0 font-size-h6-lg font-weight-bolder text-right" value="0" readonly>
                                    </div>
                                </div> --}}
                ...
                // console.log(customerId);
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            $('#alamat_penagihan').val(data[0].alamat);
                        }
                    });
...
<script type="text/javascript">
    ...
    function myCreateFunction() {
        ...
        cell1.innerHTML = `<select id='product_selected' class="product_selected form-control" name="product_selected[]">
                ...
                if ((discount_value != 0)  && pajak_value) { //kondisi jika diskon dan pajak ada
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            $('#myTable tr:nth-child('+parameter_qty+') #potongan_pajak').val(besar_pajak);
                ...
                if (!pajakId) {
                    let qty_penjualan = $('#myTable tr:nth-child('+parameter_pajak+') #qty_penjualan').val();
                        ...
                        if (discount = 0) {
                            ...
                            let potongan_pajaks = ((harga_satuan * qty_penjualan) * 0) / 100;
                            $('#myTable tr:nth-child('+parameter_pajak+') #potongan_pajak').val(potongan_pajaks);
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            if (discount = 0) {
                                ...
                                let discount_value = $('#myTable tr:nth-child('+parameter_pajak+') #disk_product').val();
                                let besar_dist = ((harga_satuan * qty_penjualan) * (discount_value) / 100);
                                $('#myTable tr:nth-child('+parameter_pajak+') #besar_product').val(besar_dist);
                                let tot_set_diskon = (harga_satuan * qty_penjualan) - besar_dist;
                                let potongan_pajaks = ((harga_satuan * qty_penjualan) * data[0].persentase) / 100;
                                $('#myTable tr:nth-child('+parameter_pajak+') #potongan_pajak').val(potongan_pajaks);
                                let hasil_setelah_dipotong = tot_set_diskon + potongan_pajaks;
                                $('#myTable tr:nth-child('+parameter_pajak+') #total_per_product').val(hasil_setelah_dipotong);
                            }
