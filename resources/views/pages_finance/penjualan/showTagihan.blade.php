    ...
    <div class="row mt-2 justify-content-center">
        <div class="col-md-12">
            <div class="box bg-white p-5 shadow-sm rounded">
                <form action="{{ url('fnc/bayar_cicilan_penjualan') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="box bg-light p-5 mt-5 rounded" id="box-show-pembelian">
                            ...
                            <table width="100%">
                                ...
                                <tr class="font-size-h6-sm font-weight-bolder">
                                    ...
                                    <tr class="font-size-h6-sm font-weight-bolder">
                                        ...
                                        <td width="5%">:</td>
                                        <td width="65%"><input type="text" id="isi_pegawai" value="{{ $data->customer->nama_customer }}" class="form-control bg-transparent border-0 font-weight-bolder" readonly></td>
                                    </tr>
                                <tr class="font-size-h6-sm font-weight-bolder">
                        ...
                        <div class="col-md-6 col-12 order-sm-1 order-lg-2">
                            ...
                            <div class="form-group mt-5">
                                ...
                                <input type="hidden" name="id_penjualan" id="" value="{{ $data->id }}">
                                @error('keterangan')
                                    <small class="error text-danger">{{ $message }}</small>
                                @enderror
                            </div>
