            ...
            <div class="box-nav shadow-sm bg-white p-5 rounded">
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div aria-current="page">
                            <h4>Buat Pemesanan Pembelian</h4>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            {{-- <div class="col-md-6 text-right">
                                <select name="penagihan" id="penagihan" class="form-control mt-2">
                                    <option value="0">Pemesanan Pembelian</option>
                                    <option value="1">Penagihan Pembelian</option>
                                </select>
                            </div> --}}
            ...
            <div class="card card-custom gutter-b border-0 shadow">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label text-gray-700">List Pembelian</h3>
                    </div>
                </div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <form action="{{ route('pembelian.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="supplier_id" name="supplier_id" onchange="myFunction()"> 
                                                    <option value="" disabled selected>-- Tentukan Supplier --</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="email_supplier" name="email_supplier" placeholder=" E.G example@mail.com" aria-label="Example text with button addon" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @php
                                            $kode = str_pad($pembelian+1,4,'0',STR_PAD_LEFT);
                                        @endphp
                                        <input type="text" name="no_transaksi" id="no_transaksi" class="form-control bg-dark-o-10" value="{{ $kode }}" readonly>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_jatuh_tempo" id="tanggal_jatuh_tempo" class="form-control" value="{{ old('tanggal_jatuh_tempo') }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" id="nominal_tagihan_group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nominal_tagihan" id="nominal_tagihan" value="{{ old('nominal_tagihan') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {{-- start table detail pembelian biasa --}}
                        ...
                        {{-- start table detail pembelian rab--}}
                        <div class="pembelian_rab" id="pembelian_rab">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-primary btn-sm" id="btnAddFormRab" onclick="myCreateFunctionRAB()">Tambah Product</button>
...
<script type="text/javascript">
    ...
    function myCreateFunction() {
        ...
        cell6.innerHTML = `<select class="form-control pajak_per_product" id="pajak_product" name="pajak_per_product[]">
                            ...
                            <input class="form-control potongan_pajak" value="0" type="hidden" id="potongan_pajak" name="potongan_pajak[]" readonly>
                        `;
        ...
        for (let q = 0; q < qty_pen.length; q++) {
            qty_pen[q].addEventListener('keyup', function(){
                ...
                if ((discount_value != 0)  && pajak_value) { //kondisi jika diskon dan pajak ada
                    ...
                    var total_set_qty = harga_satuan * qty_pembelian;
                    $('#myTable tr:nth-child('+parameter_qty+') #potongan_pajak').val();
