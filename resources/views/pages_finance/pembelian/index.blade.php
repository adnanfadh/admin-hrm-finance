                    ...
                    <div class="row mb-2 d-flex flex-row">
                        <div class="col-md-4">
                            <div class="title d-flex flex-row justify-content-center justify-content-lg-start mt-3">
                                <span><h4>Keuntungan Pembelian</h4></span>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="aksi d-flex flex-row justify-content-md-end">
                                {{-- <a href="{{ url('/fnc/showTagihanPembelian') }}" class="btn btn-primary btn-sm m-1"><i class="fas fa-book-open"> Catat Penagihan Pembelian</i></a> --}}
                                <a href="{{ route('pembelian.create') }}" class="btn btn-info btn-sm m-1"><i class="fas fa-book-open"> Catat Pemesanan Pembelian</i></a>
                    ...
                    <div class="row">
                            ...
                            <div class="card p-5 border-left-danger mt-3">
                                <div class="row">
                                    <div class="col-md-9 col-9">
                                        <h6>Seluruh Pembelian</h6>
                                        <h4 class="ml-2"><Strong>{{ "Rp. ".number_format($seluruh_pembelian,2,',','.'); }}</Strong></h4>
                                    </div>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="card p-5 border-left-info mt-3">
                                <div class="row">
                                    <div class="col-md-9">
                                        <h6>Pembelian Bulan Ini</h6>
                                        <h4 class="ml-5"><strong>{{ "Rp. ".number_format($pembelian_bulan_ini,2,',','.'); }}</strong></h4>
                                    </div>
                                    <div class="col-md-3">
                                        <span>
                                            <i class="fas fa-address-book icon-4x"></i>
                            ...
                            <div class="card p-5 border-left-primary mt-3">
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <h4 class="ml-5"><strong>{{ "Rp. ".number_format($pembelian_hari_ini,2,',','.'); }}</strong></h4>
                                    </div>
                                    <div class="col-md-3">
                                        <span>
                                            <i class="fas fa-address-book icon-4x"></i>
            ...
            <div class="card card-custom gutter-b border-0 shadow">
              ...
              <div class="card-body">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="pills-barang-tab" data-toggle="pill" href="#pills-barang" role="tab" aria-controls="pills-barang" aria-selected="true">Pembelian</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="pills-jasa-tab" data-toggle="pill" href="#pills-jasa" role="tab" aria-controls="pills-jasa" aria-selected="false">Pembelian RAB</a>
                    </li>
                  </ul>
                  <div class="tab-content bg-dark-o-10 p-2 rounded" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-jasa" role="tabpanel" aria-labelledby="pills-jasa-tab">
                        <table class="table table-hover scroll-horizontal-vertical w-100" id="crudTable_rab">
                            <thead class="bg-secondary text-white">
                                <tr>
                                    <th>No</th>
                                    <th>No Transaksi</th>
...
<script>
    // AJAX DataTable
    var datatable = $('#crudTable_rab').DataTable({
        processing: true,
            serverSide: true,
            ordering: true,
            responsive: true,
