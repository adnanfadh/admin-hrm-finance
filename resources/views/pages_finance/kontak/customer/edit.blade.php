            ...
            <div class="card card-custom gutter-b border-0 shadow">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <h3 class="card-label text-gray-700">Add Data Customer</h3>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode_customer" id="kode_customer" class="form-control bg-secondary" value="{{ $customer->kode_customer }}" readonly/>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kontak" id="kontak" class="form-control" value="{{ $customer->kontak }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
