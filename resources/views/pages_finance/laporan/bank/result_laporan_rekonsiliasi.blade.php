    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box rounded bg-white p-3">
                <h1>Daftar pembelian<span class="font-size-h5-sm text-black-50"> dalam (IDR)</span></h1>
                <hr>
            ...
            <div class="box bg-white rounded p-5 mt-3" name="ticket2" id="ticket2">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h2 class="font-weight-bolder">Daftar Pembelian</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="7" class="text-center">
                                <h2>Laporan berdasarkan tanggal tersebut belum ada!!</h2>
