    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box rounded bg-white p-3">
                ...
                <hr>
                <form action="{{ route('result_penjualan_per_pelanggan') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
            ...
            <div class="box bg-white rounded p-5 mt-3" name="ticket2" id="ticket2">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h2 class="font-weight-bolder">Penjualan Per Pelanggan</h2>
                ...
                <table class="table mt-5" style="width:100%" id="example">
                    ...
                    <tbody>
                        @forelse ($penjualan as $item)
                            ...
                            @endforeach
                            <tr>
                                <td colspan="4" class="text-right font-weight-bolder">{{ $item->nama_customer }}| Total Penjualan</td>
