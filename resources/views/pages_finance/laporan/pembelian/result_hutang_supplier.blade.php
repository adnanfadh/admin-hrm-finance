    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box rounded bg-white p-3">
                <h1>Laporan Hutang Supplier<span class="font-size-h5-sm text-black-50"> dalam (IDR)</span></h1>
                <hr>
                <form action="{{ route('result_hutang_supplier') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
            ...
            <div class="box bg-white rounded p-5 mt-3" name="ticket2" id="ticket2">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h2 class="font-weight-bolder">Lapporan Hutang Supplier</h2>
                    ...
                    <tbody>
                        @forelse ($pembelian as $item)
                            ...
                            @php
                                ...
                                $get_piutang = \App\Models\Finance\Pembelian::query()->where(['creat_by_company' => Auth::user()->pegawai->company->id])->where(['supplier_id' => $item->id])->whereBetween('tanggal_transaksi', [$tanggal_awal, $tanggal_akhir])->with(['supplier'])->sum('sisa_tagihan');
