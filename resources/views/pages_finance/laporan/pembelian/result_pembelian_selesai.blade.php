    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box rounded bg-white p-3">
                <h1>Daftar pembelian Selesai<span class="font-size-h5-sm text-black-50"> dalam (IDR)</span></h1>
                <hr>
                <form action="{{ route('result_pembelian_selesai') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-3">
            ...
            <div class="box bg-white rounded p-5 mt-3" name="ticket2" id="ticket2">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h2 class="font-weight-bolder">Daftar Pembelian Selesai</h2>
                ...
                <table class="table mt-5" style="width:100%" id="example2">
                    ...
                    <tbody>
                        ...
                        @if ($get_total > 0)
                            <tr>
                                <td colspan="5" class="text-right font-weight-bolder"> Total Penjualan</td>
