    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box rounded bg-white p-3">
                <h1>Laporan Pajak<span class="font-size-h5-sm text-black-50"> dalam (IDR)</span></h1>
                <hr>
            ...
            <div class="box bg-white rounded p-5 mt-3" name="ticket2" id="ticket2">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h2 class="font-weight-bolder">Laporan Pajak</h2>
                ...
                <table class="table mt-5" style="width:100%" id="example2">
                    <thead style="background: rgba(0, 110, 255, 0.719);">
                        <tr>
                            ...
                            <th class="text-right">Rate Pajak</th>
                    ...
                    <tbody>
                        @if ($parameter > 0)
                            <tr>
                                <td colspan="4" class="font-weight-boldest bg-primary-o-45">PPN</td>
                            </tr>
                            <tr>
                                <td><span class="ml-3">Penjualan</span></td>
                                <td class="text-right">{{ $DPP_penjualan }}</td>
                                <td class="text-right">{{ $pajak_persentase }}</td>
                                <td class="text-right">{{ $jurnal_pajak_penjualan }}</td>
                            </tr>
                            <tr>
                                <td><span class="ml-3">Pembelian</span></td>
                                <td class="text-right">{{ $DPP_pembelian }}</td>
                                <td class="text-right">{{ $pajak_persentase }}</td>
                                <td class="text-right">{{ $jurnal_pajak_pembelian }}</td>
                            </tr>
                            <tr class="bg-primary-o-45">
                                <td class="font-weight-bolder">Total</td>
                                <td class="text-right font-weight-bolder">{{ $DPP_penjualan + $DPP_pembelian }}</td>
                                <td></td>
                                <td class="text-right font-weight-bolder">{{ $jurnal_pajak_penjualan + $jurnal_pajak_pembelian }}</td>
                            </tr>
                        @else
                            <tr>
                                <td colspan="7" class="text-center">
                                    <h2>Laporan Pajak berdasarkan tanggal tersebut belum ada!!</h2>
                                </td>
                            </tr>
