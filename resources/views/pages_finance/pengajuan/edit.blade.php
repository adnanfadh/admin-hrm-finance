            ...
            <div class="card card-custom gutter-b border-0 shadow">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label text-gray-700">Edit Pengajuan</h3>
                    </div>
                </div>
                <div class="card-body">
                    @if($errors->any())
                            ...
                            <div class="row">
                                <div class="col-md-6 order-lg-1 order-sm-2 order-md-1 mt-3">
                                    <div class="form-group mt-10">
                                        ...
                                        @else
                                            <input type="radio" class="form-check-inline" name="jenis_pengajuan" id="jenis_pengajuan" value="1"><label for="jenis_pengajuan">RAB</label>
                                            <input type="radio" class="form-check-inline ml-15" name="jenis_pengajuan" id="jenis_pengajuan2" value="2" checked><label for="jenis_pengajuan2">Pengajuan Langsung</label>
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="box bg-white p-5 rounded d-flex flex-column text-right">
                                                ...
                                                <div class="nominal bg-warning-o-80 p-3 rounded">
                                                    <input type="text" id="total_global" value="{{ $data->total_nominal_pengajuan }}" class="form-control bg-transparent border-0 font-weight-bolder text-right total_global" style="font-size: 1.7rem">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_pengajuan" id="tanggal_pengajuan" class="form-control" value="{{ $data->tanggal_pengajuan }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="penerima" id="penerima" class="form-control">
                                            @foreach ($penerima as $p)
                                                <option value="{{ $p->id }}" {{ old('penerima', $data->penerima) == $p->id ? 'selected' : '' }}>{{ $p->nama }}/{{ $p->jabatan->nama }}/{{ $p->company->nama_company }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="perihal_surat" id="perihal_surat" class="form-control" value="{{ $data->perihal_surat }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="lampiran_surat" class="font-weight-bold">Lampiran Surat:</label>
                                        <input type="text" name="lampiran_surat" id="lampiran_surat" class="form-control" value="{{ $data->lampiran_surat }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-striped table-hover scroll-horizontal-vertical w-100 table-responsive-lg" width="100%">
                                        ...
                                        <tbody id="myTable">
                                            @foreach ($data->detail_pengajuan as $item)
                                                <tr>
                                                    <td>
                                                        <input class="form-control tanggal_pelaksanaan" value="{{ $item->tanggal_pelaksanaan }}" type="date" id="tanggal_pelaksanaan" name="tanggal_pelaksanaan[]">
                                                    </td>
                                                    <td>
                                                        <input class="form-control item" value="{{ $item->item }}" type="text" id="item" name="item[]">
                                                    </td>
                                                    <td>
                                                        <input class="form-control vendor" value="{{ $item->vendor }}" type="text" id="vendor" name="vendor[]">
                                                    </td>
                                                    <td>
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control harga" id="harga" name="harga[]" value="{{ $item->harga }}">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <input class="form-control jumlah_item" value="{{ $item->jumlah_item }}" type="numeric" id="jumlah_item" name="jumlah_item[]">
                                                    </td>
                                                    <td>
                                                        <div class="input-group mb-3">
                                                            <div  class="input-group-prepend">
                                                            ...
                                                            <input type="text" class="form-control budget" id="budget" name="budget[]" value="{{ $item->budget }}">
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="col-md-6">
                                <div class="row mt-10">
                                    ...
                                    <div class="col-md-7 text-right">
                                        <input type="text" name="total_nominal_pengajuan" id="total_global" class="form-control bg-transparent border-0 font-size-h6-lg font-weight-bolder text-right total_global" value="{{ $data->total_nominal_pengajuan }}" readonly>
