        ...
        <div class="col-md-12">
            <div class="card card-custom gutter-b border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('pengajuan_head.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf 
                                    ...
                                    <table class="table table-striped table-hover scroll-horizontal-vertical w-100 table-responsive-lg" width="100%">
                                        ...
                                        <tbody id="myTable">
                                            @foreach ($data->detail_pengajuan as $item)
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="status_approved_detail" id="status_approved_detail" value="1" class="status_approved_detail">
                                                    ...
                                                    <td>
                                                        <input class="form-control jumlah_item_approved" value="0" type="numeric" id="jumlah_item_approved" name="jumlah_item_approved[]">
                                                    </td>
                                                    <td>
                                                        <div class="input-group mb-3">
                                                            <div  class="input-group-prepend">
                                                    ...
                                                    <td>
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control budget_approved" id="budget_approved" name="budget_approved[]" value="0" readonly>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <input class="form-control keterangan" type="text" id="keterangan" name="keterangan[]">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row mt-10">
                                    ...
                                    <div class="col-md-7 text-right">
                                        <input type="text" name="total_nominal_approved" id="total_nominal_approved" class="form-control bg-transparent border-0 font-size-h6-lg font-weight-bolder text-right total_nominal_approved" value="0" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
