    ...
    <div class="row mt-2 justify-content-center">
        <div class="col-md-12">
            <div class="box bg-white p-5 shadow-sm rounded">
                <form action="{{ url('fnc/bayar_cicilan_biaya') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6 col-12 order-sm-2 order-lg-1">
                            <table width="100%">
                                <tr class="font-size-h6-sm font-weight-bolder">
                                    ...
                                    <td width="5%">:</td>
                                    <td width="65%"><input type="text" value="{{ $data->no_biaya }}" id="isi_no_transaksi" class="form-control bg-transparent border-0 font-weight-bolder" readonly></td>
                                </tr>
                                <tr class="font-size-h6-sm font-weight-bolder">
                                ...
                                @if ($data->penerima_supplier == NULL)
                                    <tr class="font-size-h6-sm font-weight-bolder">
                                        ...
                                        <td width="5%">:</td>
                                        <td width="65%"><input type="text" id="isi_pegawai" value="{{ $data->pegawai->nama }}" class="form-control bg-transparent border-0 font-weight-bolder" readonly></td>
                                    </tr>
                                @else
                                    <tr class="font-size-h6-sm font-weight-bolder">
                                        <td width="30%">Penerima</td>
                                        <td width="5%">:</td>
                                        <td width="65%"><input type="text" id="isi_supplier" value="{{ $data->supplier->nama_supplier }}" class="form-control bg-transparent border-0 font-weight-bolder" readonly></td>
                                    </tr>
                                @endif
                                <tr class="font-size-h6-sm font-weight-bolder">
                                    <td width="30%">Metode Pembayaran</td>
                                    <td width="5%">:</td>
                                    <td width="65%"><input type="text" id="isi_metode" value="{{ $data->metode_pembayarans->nama_metode }}" class="form-control bg-transparent border-0 font-weight-bolder" readonly></td>
                                </tr>
                                @if ($data->bayar_nanti !== NULL)
                                    <tr class="font-size-h6-sm font-weight-bolder">
                                        <td width="30%">Syarat Pembayaran</td>
                                        <td width="5%">:</td>
                                        <td width="65%"><input type="text" id="isi_syarat" value="{{ $data->syarat_pembayarans->nama_syarat }}" class="form-control bg-transparent border-0 font-weight-bolder" readonly></td>
                                    </tr>
                                @endif
                                <tr class="font-size-h6-sm font-weight-bolder">
                                    <td width="30%">Total Pembelian</td>
                                    <td width="5%">:</td>
                                    <td width="65%"><input type="text" id="isi_total_pembelian" value="{{  "Rp. ".number_format($data->grand_total,2,',','.'); }}" class="form-control bg-transparent border-0 font-weight-bolder" readonly></td>
                                </tr>
                                <tr class="font-size-h6-sm font-weight-bolder"> 
                        ...
                        <div class="col-md-6 col-12 order-sm-1 order-lg-2">
                            <div class="box bg-white rounded p-5 font-size-h4-sm font-weight-bolder text-center">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="nominal_bayar" name="nominal_bayar" class="form-control bg-warning-o-40 border-0 font-weight-bolder font-size-h3-sm @error('nominal_bayar') is-invalid @enderror">
                                    <br>
                                </div>
                                @error('nominal_bayar')
                            ...
                            <div class="form-group mt-5">
                                ...
                                <input type="date" name="tanggal_bayar" id="tanggal_bayar" class="form-control @error('nominal_bayar') is-invalid @enderror" value="{{ old('tanggal_bayar') }}">
                                @error('tanggal_bayar')
                                    <small class="error text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="form-group mt-5">
                                ...
                                <input type="hidden" name="id_biaya" id="" value="{{ $data->id }}">
                            </div>
                            <div class="form-group mt-5">
