                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex flex-column justify-content-center mt-3">
                                            <div class="form-group">
                                                ...
                                                @else
                                                    <input type="checkbox" id="bayar_nanti" class="checkbox-lg" name="bayar_nanti" value="bayar nanti" checked>
                                                    <label for="bayar_nanti" class="font-weight-bold font-size-h4-xl">Bayar Nanti</label>
                                                @endif
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="penerima_supplier" id="penerima_supplier" class="custom-select">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_biaya" id="no_biaya" class="form-control" value="{{ $data->no_biaya }}">
                                    </div>
                                    <div class="form-group" id="form_syarat_pembayaran">
                                        ...
                                        <select name="syarat_pembayaran" id="syarat_id" class="form-control" onchange="AddSyaratShow()">
                                            ...
                                            @foreach ($syarat_pembayaran as $s)
                                                <option value="{{ $s->id }}" {{ old('syarat_pembayaran', $data->syarat_pembayaran) == $s->id ? 'selected' : '' }}>{{ $s->nama_syarat }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="metode_pembayaran" id="metode_id" class="form-control" onchange="AddMetodeShow()">
                                            ...
                                            @foreach ($metode_pembayaran as $met)
                                                <option value="{{ $met->id }}" {{ old('metode_pembayaran', $data->metode_pembayaran) == $met->id ? 'selected' : '' }}>{{ $met->nama_metode }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover scroll-horizontal-vertical w-100 table-responsive-lg" width="100%">
                                        ...
                                        <tbody id="myTable">
                                            @forelse ($detail_biayas as $item)
                                                <tr>
                                                    <td>
                                                        <select id='akun_biaya' class="akun_biaya form-control" name="akun_biaya[]">
                                                            <option value="" disabled selected>-- Pilih Akun --</option>
                                                            @foreach ($account_biaya as $bi)
                                                                <option value="{{ $bi->id }}" {{ old('akun_biaya', $item->akun_biaya) == $bi->id ? 'selected' : '' }}>({{ $bi->nomor }}){{ $bi->nama }}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    <td>
