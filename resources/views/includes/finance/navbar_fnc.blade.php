            ...
            <div class="topbar">
                ...
                <div class="topbar-item">
                    <div class="swich-account">
                        <a href="/dashboard" class="btn btn-secondary mr-5"> <i class="fa fa-refresh" aria-hidden="true"></i>Switch Account</a>
                    </div>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="subheader subheader-solid pl-5 pr-5" id="kt_subheader">
            {{-- <marquee class="w-100" behavior="alternate" direction="left">
                <h3 class="text-dark-25">Finance PT. Dzawani Teknologi Indonesia</h3>
            </marquee> --}}
            <marquee class="w-100" behavior="alternate" direction="left">
                <h3 class="text-dark-25">HRD PT. ABCDEFGH</h3>
                   </marquee>
        </div>
        <!--end::Subheader--> 