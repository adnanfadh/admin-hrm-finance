                                            ...
                                            <div class="row">
                                                @foreach ($permission_list as $value)
                                                    <div class="col-md-4 col-6">
                                                        ...
                                                        <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $role_permission_list) ? true : false, array('class' => 'name_list')) }} {{ $value->keterangan }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                @foreach ($permission_create as $value)
                                                    <div class="col-md-4 col-6">
                                                        ...
                                                        <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $role_permission_create) ? true : false, array('class' => 'name_create')) }} {{ $value->keterangan }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                @foreach ($permission_edit as $value)
                                                    <div class="col-md-4 col-6">
                                                        ...
                                                        <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $role_permission_edit) ? true : false, array('class' => 'name_edit')) }} {{ $value->keterangan }}</label>
                                            ...
                                            <div class="row">
                                                @foreach ($permission_delete as $value)
                                                    <div class="col-md-4 col-6">
                                                        ...
                                                        <label>{{ Form::checkbox('permission[]', $value->id, in_array($value->id, $role_permission_delete) ? true : false, array('class' => 'name_delete')) }} {{ $value->keterangan }}</label>
...
<script type="text/javascript">
        ...
        //                     document.getElementById('check_list').checked = true;
        //             }
        //     }
        // }
