            ...
            <div class="col-12 col-md-12 col-lg-10">
              <div class="card card-custom gutter-b border-0 shadow">
                <div class="card-header">
                  <div class="card-title d-plex w-100 justify-content-between">
                    <h3 class="card-label text-gray-700">List Departemen</h3>
                    <a href="{{ route('departement.create') }}" class="btn btn-primary">Add Departemen</a>
                  </div>
                </div>
