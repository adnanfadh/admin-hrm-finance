                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" name="kode_company" id="kode_company" class="form-control rol @error('kode_company') is-invalid @enderror">
                          @error('kode_company')
                      ...
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <input type="text" name="nama_company" id="nama_company" class="form-control rol @error('nama_company') is-invalid @enderror" value="{{ old('nama_company') }}">
                          @error('nama_company')
                            <div class="alert alert-danger mt-1">
                              {{ $message }}
                            </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="email_company" id="email_company" class="form-control rol @error('email_company') is-invalid @enderror" value="{{ old('email_company') }}">
                          @error('email_company')
                            <div class="alert alert-danger mt-1">
                              {{ $message }}
                            </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="npwp_company" id="npwp_company" class="form-control rol @error('npwp_company') is-invalid @enderror" value="{{ old('npwp_company') }}">
                          @error('npwp_company')
                            <div class="alert alert-danger mt-1">
                              {{ $message }}
                            </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="telpon_company" id="telpon_company" class="form-control rol @error('telpon_company') is-invalid @enderror" value="{{ old('telpon_company') }}">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="file" name="logo_company" id="logo_company" class="form-control rol @error('logo_company') is-invalid @enderror" value="{{ old('logo_company') }}">
                          @error('logo_company')
                            <div class="alert alert-danger mt-1">
                              {{ $message }}
                            </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea name="alamat_company" id="alamat_company" class="form-control @error('alamat_company') is-invalid @enderror" cols="30" rows="10">{{ old('alamat_company') }}</textarea>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="website_company" id="website_company" class="form-control" value="{{ old('website_company') }}">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
