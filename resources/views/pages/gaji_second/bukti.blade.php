                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                         <div class="form-group justify-content-center">
                                            ...
                                            {{-- <input class="form-control" type="date" nama="tanggal" value="2011-08" id="example-month-input"/> --}}

                                            <div class="input-group" id='kt_daterangepicker_3'>
                                              <div class="input-group-prepend">
                                              <span class="input-group-text"><i class="la la-calendar-check-o"></i></span>
                                              </div>
                                              <input type="text" name="tanggal" class="form-control" placeholder="date range">
                                              </div>
